...
const EXT_ICON_MAP: Record<string, FileIconConfig> = {
  ...
  txt:   { icon: '📄', color: 'var(--text-tertiary)' },
  rst:   { icon: '📄', color: 'var(--text-tertiary)' },
  pdf:   { icon: '📕', color: '#e03131' },
  // Config
  env:   { icon: '⚙️',  color: 'var(--success)' },
  ini:   { icon: '⚙️',  color: 'var(--success)' },
  conf:  { icon: '⚙️',  color: 'var(--success)' },
  cfg:   { icon: '⚙️',  color: 'var(--success)' },
  // Shell
  ...
  lua:   { icon: '🌙', color: 'var(--text-inverse)080' },
  r:     { icon: 'R',  color: '#198CE7' },
  // Images
  png:   { icon: '🖼️', color: 'var(--text-tertiary)' },
  jpg:   { icon: '🖼️', color: 'var(--text-tertiary)' },
  jpeg:  { icon: '🖼️', color: 'var(--text-tertiary)' },
  gif:   { icon: '🖼️', color: 'var(--text-tertiary)' },
  svg:   { icon: '🖼️', color: '#FFB13B' },
  webp:  { icon: '🖼️', color: 'var(--text-tertiary)' },
  ico:   { icon: '🖼️', color: 'var(--text-tertiary)' },
  // Build / Package
  lock:  { icon: '🔒', color: 'var(--text-tertiary)' },
...
const FILENAME_ICON_MAP: Record<string, FileIconConfig> = {
  ...
  '.env':          { icon: '⚙️',  color: 'var(--success)' },
  '.env.local':    { icon: '⚙️',  color: 'var(--success)' },
  '.gitignore':    { icon: '🙈', color: 'var(--text-tertiary)' },
  '.gitattributes':{ icon: '🙈', color: 'var(--text-tertiary)' },
  'package.json':  { icon: '📦', color: '#f0db4f' },
  'package-lock.json': { icon: '🔒', color: 'var(--text-tertiary)' },
