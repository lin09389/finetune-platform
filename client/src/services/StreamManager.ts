...
export interface StreamEvent {
  type: 'connected' | 'disconnected' | 'chunk' | 'error' | 'heartbeat' | 'reconnecting' | 'resumed' | 'completed' | 'partial_saved'
  data?: any
  timestamp: number
}
...
export class StreamManager {
  ...
  isActive(): boolean {
    return this.state.connectionState === ConnectionState.STREAMING ||
