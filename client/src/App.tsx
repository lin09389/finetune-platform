      ...
      <ConfigProvider
        ...
        theme={{
          ...
          token: {
            ...
            colorBgBase: theme === 'dark' ? 'rgba(0, 0, 0, 0.8)' : 'rgba(252, 252, 252, 0.8)',
            colorBgContainer: theme === 'dark' ? 'rgba(9, 9, 11, 0.65)' : 'rgba(255, 255, 255, 0.65)',
            colorBgElevated: theme === 'dark' ? 'rgba(24, 24, 27, 0.8)' : 'rgba(255, 255, 255, 0.8)',
