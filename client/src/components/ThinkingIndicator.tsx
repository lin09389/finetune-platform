...
import { LoadingOutlined, BulbOutlined, ThunderboltOutlined, CheckCircleOutlined } from '@ant-design/icons'
      ...
      <div style={{
        ...
        <motion.div
          ...
          style={{
            ...
            top: 0,
            height: '100%',
            background: 'linear-gradient(90deg, var(--primary-500) 0%, var(--accent-primary) 100%)',
            borderRadius: 2,
          }}
        />
        <motion.div
