...
class AppLauncher:
    def __init__(self, whitelist: AppWhitelist | None = None):
...
_launcher_instance: AppLauncher | None = None


def get_launcher(whitelist: AppWhitelist | None = None) -> AppLauncher:
