...
class AppWhitelist:
    def __init__(self, config_path: Path | None = None):
        ...
        self._config: WhitelistConfig | None = None
    ...
    def get_executable(self, app_name: str) -> str | None:
        if not self._initialized:
            self.initialize()
    ...
    def _find_entry(self, query: str) -> WhitelistEntry | None:
        if not self._config:
            return None
    ...
    def get_entry(self, app_name: str) -> WhitelistEntry | None:
        if not self._initialized:
            self.initialize()
...
_whitelist_instance: AppWhitelist | None = None


def get_whitelist(config_path: Path | None = None) -> AppWhitelist:
