...
from .param_extractor import ParamExtractor, ExtractedParam
...
class ContextAwareParser:
    ...
    def _get_context_replacement(self, ref_type: str) -> Optional[str]:
        if ref_type == 'file':
    ...
    def _get_reference_value(self, ref_type: str) -> Optional[str]:
    ...
    def _detect_file_reference(self, message: str) -> Optional[str]:
    ...
    def _detect_app_reference(self, message: str) -> Optional[str]:
    ...
    def _infer_param(self, param: str, message: str) -> Optional[Any]:
        if param == 'file_path':
            if self.context.last_file:
                return self.context.last_file
