...
from .models import DEFAULT_ROLE_DEFINITIONS, Permission, Role


class RoleInheritance:
    """角色继承关系"""

    INHERITANCE_TREE: dict[Role, Role | None] = {
    ...
    @classmethod
    def get_parent(cls, role: Role) -> Role | None:
        """获取父角色"""
...
class PermissionInheritance:
    ...
    @classmethod
    def get_effective_permissions(cls, role: Role, custom_permissions: set[Permission] | None = None) -> set[Permission]:
        """获取有效权限（含继承和自定义）"""
