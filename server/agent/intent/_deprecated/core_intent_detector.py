...
class ParameterExtractor:
    ...
    def extract_path(self, text: str) -> ExtractedParam | None:
        """提取文件路径"""
    ...
    def extract_date(self, text: str) -> ExtractedParam | None:
        """提取日期"""
...
class IntentClarifier:
    ...
    def _identify_missing_param(self, intent: DetectedIntent) -> str | None:
        """识别缺失的参数"""
    ...
    def get_dialog(self, dialog_id: str) -> ClarificationDialog | None:
        """获取活跃的澄清对话"""
...
_detector_instance: EnhancedIntentDetector | None = None
