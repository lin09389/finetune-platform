...
class SmartParamExtractor:
    ...
    @classmethod
    def extract_file_path(cls, message: str) -> Optional[str]:
        """提取文件路径"""
    ...
    @classmethod
    def extract_app_name(cls, message: str) -> Optional[str]:
        """提取应用名称"""
    ...
    @classmethod
    def extract_url(cls, message: str) -> Optional[str]:
        """提取URL"""
...
只返回 JSON，不要其他内容。"""
    ...
    def _parse_llm_response(self, response: str) -> Optional[SmartIntentResult]:
        """解析 LLM 响应"""
        try:
