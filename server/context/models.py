...
class SymbolInfo(BaseModel):
    ...
    file_path: Optional[str] = Field(None, description="所属文件路径")
...
class FileInfo(BaseModel):
    ...
    embedding: Optional[List[float]] = Field(None, description="向量化表示")
    updated_at: Optional[str] = Field(None, description="最后修改时间")
...
class GitInfo(BaseModel):
    ...
    last_commit: Optional[str] = Field(None, description="最后提交信息")
    last_commit_date: Optional[str] = Field(None, description="最后提交时间")
...
class ProjectInfo(BaseModel):
    ...
    structure: Optional[ProjectStructure] = Field(None, description="项目结构树")
    ...
    architecture: Optional[str] = Field(None, description="架构模式：MVC/Microservices 等")
    domain: Optional[str] = Field(None, description="项目领域：电商/社交/金融/AI 等")
...
class ContextInfo(BaseModel):
    ...
    tech_stack: Optional[TechStack] = Field(default=None, description="技术栈")
    key_files: List[FileInfo] = Field(default_factory=list, description="关键文件")
