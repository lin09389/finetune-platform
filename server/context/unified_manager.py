...
class ContextOptions:
    ...
    memory_include_types: Optional[List[str]] = None
...
class ContextCache:
    ...
    def get(self, query: str, user_id: str, session_id: str, options: ContextOptions) -> Optional[UnifiedContext]:
        """获取缓存的上下文"""
...
_manager_instance: Optional[UnifiedContextManager] = None
