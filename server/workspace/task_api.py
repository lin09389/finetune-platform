...
@router.put("/{task_id}/subtasks/{subtask_id}", response_model=Task, summary="更新子任务状态")
...
@router.post("/{task_id}/start", response_model=Task, summary="开始任务")
...
@router.post("/notifications/{notification_id}/read", summary="标记通知为已读")
